...
function CollapsibleCard(props) {
  ...
  return (
    <>
      <div className="mr-auto ml-auto rounded-lg w-full md:w-6/12 py-2" data-aos="fade-left">
        <div onClick={toggleHidden} className={"bg-gray-800 text-white font-semibold hover:text-gray-700 focus:outline-none cursor-pointer" + (isHidden ? " rounded-lg" : " rounded-t-lg")} id="headingOne">
          <h3 className="px-10 py-6 text-center">
            {props.title}
          </h3>
        </div>
        <div className={"text-left transition-transform" + (isHidden ? " hidden" : "")}
        >
